...
﻿<html>
  <head>
    ...
    <title>ean8</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    ...
    <p>
					The 
					<b>ean8</b> META Tag is an action tag used to enable or disable the ean8 decoder.</p>
    ...
    <div id="SyntaxSpan" style="display:block">
      <blockquote>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <th class="clsSyntaxHeadings">ean8 (META Tag) Syntax
						</th>
          </tr>
          <tr>
            <td class="clsSyntaxCells">
              <p>&lt;META HTTP-Equiv="scanner" content="ean8:[parameter]"&gt;</p>
            </td>
          </tr>
        </table>
      </blockquote><br></div>
    ...
    <div id="ParametersWSpan" style="display:block">
      <blockquote>
          ...
          <tr>
            <td valign="top" class="clsSyntaxCells"><b>ean8:[Value]
													</b></td>
            <td valign="top" class="clsSyntaxCells">enabled/Disabled</td>
            <td valign="top" class="clsSyntaxCells">Enables/Disables the ean8 decoder.</td>
...
The ean8 META Tag is an action tag used to enable or disable the ean8 decoder.
--&gt;

&lt;!-- &lt;META HTTP-Equiv="Scanner" Content="ean8:[Value]"&gt; --&gt;      &lt;!-- Enables/Disables the ean8 decoder. --&gt;</textarea></div>
   ...
   */
   ...
   function doean8Init()
   {
      ...
      //objGeneric.InvokeMETAFunction('Scanner', 'ean8:[Value]');      /* Enables/Disables the ean8 decoder. */
...
&lt;/script&gt;</textarea></div>
    ...
    <div id="ExamplesSpan" style="display:block">
      <blockquote>
        <p>The following example enables the scanner to read only ean8 labels:</p>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <td>
...
&lt;META HTTP-Equiv="scanner-enabled" Content="SCN1"&gt;
        ...
        <p>The following example enables the scanner to read all labels except ean8:</p>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <td>
              <pre class="clsSyntaxCells">
      ...
      <blockquote>
        <table>
          ...
          <tr>
            ...
            <td>Scanner or Imager module and device supports ean8.</td>
          </tr>
        </table>
      </blockquote><br></div>
