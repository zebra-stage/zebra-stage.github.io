...
﻿<html>
  <head>
    ...
    <title>msiCheckDigitScheme</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    <table width="100%">
      <tr>
        <td valign="middle" width="95%">
          <h1>msiCheckDigitScheme META Tag</h1>
        </td>
    ...
    <p>
					The 
					<b>msiCheckDigitScheme</b> META Tag is an action tag used to set the msiCheckDigitScheme property to describe the check digit scheme to verify.</p>
