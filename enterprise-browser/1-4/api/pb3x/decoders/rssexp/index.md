...
﻿<html>
  <head>
    ...
    <title>rssexp</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    ...
    <p>
					The 
					<b>rssexp</b> META Tag is an action tag used to enable or disable the rssexp decoder.</p>
    ...
    <div id="SyntaxSpan" style="display:block">
      <blockquote>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <th class="clsSyntaxHeadings">rssexp (META Tag) Syntax
						</th>
          </tr>
          <tr>
    ...
    <div id="ParametersWSpan" style="display:block">
      <blockquote>
          ...
          <tr>
            <td valign="top" class="clsSyntaxCells"><b>rssexp:[Value]
													</b></td>
            <td valign="top" class="clsSyntaxCells">enabled/Disabled</td>
            <td valign="top" class="clsSyntaxCells">Enables/Disables the rssexp decoder.</td>
...
The rssexp META Tag is an action tag used to enable or disable the rssexp decoder.
--&gt;

&lt;!-- &lt;META HTTP-Equiv="Scanner" Content="rssexp:[Value]"&gt; --&gt;      &lt;!-- Enables/Disables the rssexp decoder. --&gt;</textarea></div>
        <div style="display:none"><textarea id="txtJavascriptTemplateW">&lt;script&gt;
   /*
   The rssexp META Tag is an action tag used to enable or disable the rssexp decoder.
   */

   function dorssexpInit()
   {
      var objGeneric = new ActiveXObject("PocketBrowser.Generic");

      //objGeneric.InvokeMETAFunction('Scanner', 'rssexp:[Value]');      /* Enables/Disables the rssexp decoder. */
...
&lt;META HTTP-Equiv="scanner" Content="enabled"&gt;
        ...
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <td>
              <pre class="clsSyntaxCells">
&lt;META HTTP-Equiv="scanner" Content="all_decoders:disabled;rssexp:enabled;enabled"&gt;
</pre>
            </td>
          </tr>
        </table>
