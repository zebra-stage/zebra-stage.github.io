...
﻿<html>
  <head>
    ...
    <title>Signature</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    ...
    <p>
					The 
					<b>Signature</b> META Tag is an action tag used to enable or disable the Signature decoder.</p>
    ...
    <div id="SyntaxSpan" style="display:block">
      <blockquote>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <th class="clsSyntaxHeadings">Signature (META Tag) Syntax
						</th>
          </tr>
          <tr>
    ...
    <div id="ParametersWSpan" style="display:block">
      <blockquote>
          ...
          <tr>
            <td valign="top" class="clsSyntaxCells"><b>Signature:[Value]
													</b></td>
            <td valign="top" class="clsSyntaxCells">enabled/Disabled</td>
            <td valign="top" class="clsSyntaxCells">Enables/Disables the Signature decoder.</td>
...
The Signature META Tag is an action tag used to enable or disable the Signature decoder.
--&gt;

&lt;!-- &lt;META HTTP-Equiv="Scanner" Content="Signature:[Value]"&gt; --&gt;      &lt;!-- Enables/Disables the Signature decoder. --&gt;</textarea></div>
        <div style="display:none"><textarea id="txtJavascriptTemplateW">&lt;script&gt;
   /*
   The Signature META Tag is an action tag used to enable or disable the Signature decoder.
   */

   function doSignatureInit()
   {
      var objGeneric = new ActiveXObject("PocketBrowser.Generic");

      //objGeneric.InvokeMETAFunction('Scanner', 'Signature:[Value]');      /* Enables/Disables the Signature decoder. */
...
&lt;META HTTP-Equiv="scanner" Content="enabled"&gt;
        ...
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <td>
              <pre class="clsSyntaxCells">
&lt;META HTTP-Equiv="scanner" Content="all_decoders:disabled;Signature:enabled;enabled"&gt;
</pre>
            </td>
          </tr>
        </table>
      ...
      <blockquote>
        <table>
          ...
          <tr>
            ...
            <td>Scanner or Imager module and device supports Signature.</td>
          </tr>
        </table>
      </blockquote><br></div>
