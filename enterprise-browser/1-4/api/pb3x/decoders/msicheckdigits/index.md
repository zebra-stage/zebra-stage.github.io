...
﻿<html>
  <head>
    ...
    <title>msicheckdigits</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    ...
    <p>
					The 
					<b>msicheckdigits</b> META Tag is an action tag used to set the msi checkdigits property.</p>
    ...
    <div id="SyntaxSpan" style="display:block">
      <blockquote>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <th class="clsSyntaxHeadings">msicheckdigits (META Tag) Syntax
						</th>
          </tr>
          <tr>
    ...
    <div id="ParametersWSpan" style="display:block">
      <blockquote>
          ...
          <tr>
            <td valign="top" class="clsSyntaxCells"><b>msicheckdigits:[Value]
													</b></td>
            <td valign="top" class="clsSyntaxCells">one/two</td>
            <td valign="top" class="clsSyntaxCells">Sets the msi checkdigits property to one or two.</td>
...
The msicheckdigits META Tag is an action tag used to set the msi checkdigits property.
--&gt;

&lt;!-- &lt;META HTTP-Equiv="Scanner" Content="msicheckdigits:[Value]"&gt; --&gt;      &lt;!-- Sets the msi checkdigits property to one or two. --&gt;</textarea></div>
        <div style="display:none"><textarea id="txtJavascriptTemplateW">&lt;script&gt;
   /*
   The msicheckdigits META Tag is an action tag used to set the msi checkdigits property.
   */

   function domsicheckdigitsInit()
   {
      var objGeneric = new ActiveXObject("PocketBrowser.Generic");

      //objGeneric.InvokeMETAFunction('Scanner', 'msicheckdigits:[Value]');      /* Sets the msi checkdigits property to one or two. */
...
&lt;/script&gt;</textarea></div>
    ...
    <div id="ExamplesSpan" style="display:block">
      <blockquote>
        <p>The following example enables the scanner to read only msi labels with the checkdigits property set:</p>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <td>
