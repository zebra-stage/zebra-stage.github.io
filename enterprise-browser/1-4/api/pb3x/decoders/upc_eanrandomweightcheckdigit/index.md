---
title: upc_eanrandomweightcheckdigit.md
productversion: '1.4'
...
﻿<html>
  <head>
    ...
    <title>upc_eanrandomweightcheckdigit</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    <table width="100%">
      <tr>
        <td valign="middle" width="95%">
          <h1>upc_eanrandomweightcheckdigit META Tag</h1>
        </td>
    ...
    <p>
					The 
					<b>upc_eanrandomweightcheckdigit</b> META Tag is an action tag used to enable or disable the upc_ean-randomweightcheckdigit property for random weight check digit verification.</p>
    ...
    <div id="SyntaxSpan" style="display:block">
      <blockquote>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <th class="clsSyntaxHeadings">upc_eanrandomweightcheckdigit (META Tag) Syntax
						</th>
          </tr>
          <tr>
            <td class="clsSyntaxCells">
              <p>&lt;META HTTP-Equiv="scanner" content="upc_eanrandomweightcheckdigit:[parameter]"&gt;</p>
            </td>
          </tr>
        </table>
      </blockquote><br></div>
    ...
    <div id="ParametersWSpan" style="display:block">
      <blockquote>
          ...
          <tr>
            <td valign="top" class="clsSyntaxCells"><b>upc_eanrandomweightcheckdigit:[Value]
													</b></td>
            <td valign="top" class="clsSyntaxCells">true/false</td>
            <td valign="top" class="clsSyntaxCells">Enables the upc_ean-randomweightcheckdigit property.</td>
...
The upc_eanrandomweightcheckdigit META Tag is an action tag used to enable or disable the upc_ean-randomweightcheckdigit property for random weight check digit verification.
--&gt;

&lt;!-- &lt;META HTTP-Equiv="Scanner" Content="upc_eanrandomweightcheckdigit:[Value]"&gt; --&gt;      &lt;!-- Enables the upc_ean-randomweightcheckdigit property. --&gt;</textarea></div>
        <div style="display:none"><textarea id="txtJavascriptTemplateW">&lt;script&gt;
   /*
   The upc_eanrandomweightcheckdigit META Tag is an action tag used to enable or disable the upc_ean-randomweightcheckdigit property for random weight check digit verification.
   */

   function doupc_eanrandomweightcheckdigitInit()
   {
      var objGeneric = new ActiveXObject("PocketBrowser.Generic");

      //objGeneric.InvokeMETAFunction('Scanner', 'upc_eanrandomweightcheckdigit:[Value]');      /* Enables the upc_ean-randomweightcheckdigit property. */
...
&lt;/script&gt;</textarea></div>
    ...
    <div id="ExamplesSpan" style="display:block">
      <blockquote>
        <p>The following example turns on the upc_ean-randomweightcheckdigit property:</p>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <td>
              <pre class="clsSyntaxCells">
&lt;META HTTP-Equiv="scanner" Content="all_decoders:enabled"&gt;
&lt;META HTTP-Equiv="scanner" Content="upc_eanrandomweightcheckdigit:true"&gt;
...
The following example turns on the upc_ean-randomweightcheckdigit property:
--&gt;
...
&lt;META HTTP-Equiv="scanner" Content="enabled"&gt;
        ...
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <td>
              <pre class="clsSyntaxCells">
&lt;META HTTP-Equiv="scanner" Content="all_decoders:enabled;upc_eanrandomweightcheckdigit:true;enabled"&gt;
</pre>
            </td>
          </tr>
        </table>
...
&lt;META HTTP-Equiv="scanner-upc_eanrandomweightcheckdigit" Content="true"&gt;
      ...
      <blockquote>
        <table>
          ...
          <tr>
            ...
            <td>Scanner or Imager module and device supports upc_ean-randomweightcheckdigit property.</td>
          </tr>
        </table>
      </blockquote><br></div>
