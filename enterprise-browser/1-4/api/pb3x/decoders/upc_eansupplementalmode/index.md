---
title: upc_eansupplementalmode.md
productversion: '1.4'
...
﻿<html>
  <head>
    ...
    <title>upc_eansupplementalmode</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    <table width="100%">
      <tr>
        <td valign="middle" width="95%">
          <h1>upc_eansupplementalmode META Tag</h1>
        </td>
    ...
    <p>
					The 
					<b>upc_eansupplementalmode</b> META Tag is an action tag used to set the upc_eansupplementalmode.</p>
    ...
    <div id="SyntaxSpan" style="display:block">
      <blockquote>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <th class="clsSyntaxHeadings">upc_eansupplementalmode (META Tag) Syntax
						</th>
          </tr>
          <tr>
    ...
    <div id="ParametersWSpan" style="display:block">
      <blockquote>
          ...
          <tr>
            <td valign="top" class="clsSyntaxCells"><b>upc_ean-supplementalmode:[Value]
													</b></td>
            <td valign="top" class="clsSyntaxCells">none/always/auto</td>
            <td valign="top" class="clsSyntaxCells">if 'none' Supplemental barcodes are ignored.if 'always' then Will not decode upc/ean without supplementals.
                                , if 'auto' then Auto-discriminates supplementals. </td>
...
The upc_eansupplementalmode META Tag is an action tag used to set the upc_eansupplementalmode.
--&gt;

&lt;!-- &lt;META HTTP-Equiv="Scanner" Content="upc_ean-supplementalmode:[Value]"&gt; --&gt;      &lt;!-- if 'none' Supplemental barcodes are ignored.if 'always' then Will not decode upc/ean without supplementals.
                                , if 'auto' then Auto-discriminates supplementals.  --&gt;</textarea></div>
        <div style="display:none"><textarea id="txtJavascriptTemplateW">&lt;script&gt;
   /*
   The upc_eansupplementalmode META Tag is an action tag used to set the upc_eansupplementalmode.
   */

   function doupc_eansupplementalmodeInit()
   {
      var objGeneric = new ActiveXObject("PocketBrowser.Generic");

      //objGeneric.InvokeMETAFunction('Scanner', 'upc_ean-supplementalmode:[Value]');      /* if 'none' Supplemental barcodes are ignored.if 'always' then Will not decode upc/ean without supplementals.
                                , if 'auto' then Auto-discriminates supplementals.  */
...
&lt;/script&gt;</textarea></div>
    ...
    <div id="ExamplesSpan" style="display:block">
      <blockquote>
        <p>The following will only read upc/ean codes with supplementals:</p>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <td>
              <pre class="clsSyntaxCells">
&lt;META HTTP-Equiv="scanner" Content="all_decoders:enabled"&gt;
&lt;META HTTP-Equiv="scanner" Content="upc_eansupplementalmode:always"&gt;
...
&lt;META HTTP-Equiv="scanner" Content="enabled"&gt;
        ...
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <td>
              <pre class="clsSyntaxCells">
&lt;META HTTP-Equiv="scanner" Content="all_decoders:enabled;upc_eansupplementalmode:always;enabled"&gt;
</pre>
            </td>
          </tr>
        </table>
...
&lt;META HTTP-Equiv="scanner-upc_eansupplementalmode" Content="always"&gt;
...
&lt;META HTTP-Equiv="scanner-enabled" Content="SCN1"&gt;
      ...
      <blockquote>
        <table>
          ...
          <tr>
            ...
            <td>Scanner or Imager module and device supports decoding upc_ean-supplemental barcodes.</td>
          </tr>
        </table>
      </blockquote><br></div>
    ...
    <div id="AlsoSpan" style="display:block">
      <BLOCKQUOTE><a href="../Scanner.html&#xA;						">Scanner</a> <a href="upc_ean-supplemental2.html&#xA;						">upc_ean-supplemental2</a> <a href="upc_ean-supplemental5.html&#xA;						">upc_ean-supplemental5</a> <a href="upc_ean-retrycount.html&#xA;						">upc_ean-retrycount</a> <a href="All_Decoders.html&#xA;						">All_Decoders</a> </BLOCKQUOTE><br></div>
    <hr size="1">
