...
﻿<html>
  <head>
    ...
    <title>msiRedundancy</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    ...
    <p>
					The 
					<b>msiRedundancy</b> META Tag 	is an action tag used to set the msi Redundancy property. If this flag is set, the bar code must be decoded twice before being accepted.</p>
        ...
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          ...
          <tr>
            <td class="clsSyntaxCells">
              <p>&lt;META HTTP-Equiv="scanner" content="msiRedundancy:[parameter]"&gt;</p>
            </td>
          </tr>
        </table>
      </blockquote><br></div>
