...
﻿<html>
  <head>
    ...
    <title>upc_eanretrycount</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    <table width="100%">
      <tr>
        <td valign="middle" width="95%">
          <h1>upc_eanretrycount META Tag</h1>
        </td>
    ...
    <p>
					The 
					<b>upc_eanretrycount</b> META Tag is an action tag used to set the upc_ean retrycount for auto-discriminating for supplementals. Possible values are 2 to 10 inclusive.</p>
    ...
    <div id="SyntaxSpan" style="display:block">
      <blockquote>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <th class="clsSyntaxHeadings">upc_eanretrycount (META Tag) Syntax
						</th>
          </tr>
          <tr>
    ...
    <div id="ParametersWSpan" style="display:block">
      <blockquote>
          ...
          <tr>
            <td valign="top" class="clsSyntaxCells"><b>upc_eanretrycount:[Value]
													</b></td>
            <td valign="top" class="clsSyntaxCells">Numeric value (2 - 10)</td>
            <td valign="top" class="clsSyntaxCells">Sets the retry count for auto-discriminating for supplementals (2 - 10).</td>
...
The upc_eanretrycount META Tag is an action tag used to set the upc_ean retrycount for auto-discriminating for supplementals. Possible values are 2 to 10 inclusive.
--&gt;

&lt;!-- &lt;META HTTP-Equiv="Scanner" Content="upc_eanretrycount:[Value]"&gt; --&gt;      &lt;!-- Sets the retry count for auto-discriminating for supplementals (2 - 10). --&gt;</textarea></div>
        <div style="display:none"><textarea id="txtJavascriptTemplateW">&lt;script&gt;
   /*
   The upc_eanretrycount META Tag is an action tag used to set the upc_ean retrycount for auto-discriminating for supplementals. Possible values are 2 to 10 inclusive.
   */

   function doupc_eanretrycountInit()
   {
      var objGeneric = new ActiveXObject("PocketBrowser.Generic");

      //objGeneric.InvokeMETAFunction('Scanner', 'upc_eanretrycount:[Value]');      /* Sets the retry count for auto-discriminating for supplementals (2 - 10). */
...
&lt;/script&gt;</textarea></div>
    ...
    <div id="ExamplesSpan" style="display:block">
      <blockquote>
        <p>The following example sets the scanner to retry upc_ean codes 8 times:</p>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <td>
              <pre class="clsSyntaxCells">
&lt;META HTTP-Equiv="scanner" Content="all_decoders:disabled"&gt;
&lt;META HTTP-Equiv="scanner" Content="upc_eansupplementalmode:auto"&gt;
&lt;META HTTP-Equiv="scanner" Content="upc_eanretrycount:8"&gt;
...
&lt;META HTTP-Equiv="scanner-upc_eansupplementalmode" Content="auto"&gt;
&lt;META HTTP-Equiv="scanner-upc_eanretrycount" Content="8"&gt;
...
&lt;META HTTP-Equiv="scanner-enabled" Content="SCN1"&gt;
      ...
      <blockquote>
        <table>
          ...
          <tr>
            ...
            <td>Scanner or Imager module and device supports upc_ean.</td>
          </tr>
        </table>
      </blockquote><br></div>
    ...
    <div id="AlsoSpan" style="display:block">
      <BLOCKQUOTE><a href="../Scanner.html&#xA;						">Scanner</a> <a href="upc_eansupplementalmode.html&#xA;						">upc_eansupplementalmode</a> <a href="All_Decoders.html&#xA;						">All_Decoders</a> </BLOCKQUOTE><br></div>
    <hr size="1">
