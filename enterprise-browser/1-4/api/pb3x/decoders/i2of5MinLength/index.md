...
﻿<html>
  <head>
    ...
    <title>i2of5MinLength</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    ...
    <p>
					The 
					<b>i2of5MinLength</b> META Tag is an action tag used to set the i2of5 MinLength property.</p>
    ...
    <div id="SyntaxSpan" style="display:block">
      <blockquote>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <th class="clsSyntaxHeadings">i2of5MinLength (META Tag) Syntax
						</th>
          </tr>
          <tr>
            <td class="clsSyntaxCells">
              <p>&lt;META HTTP-Equiv="scanner" content="i2of5minlength:[parameter]"&gt;</p>
            </td>
          </tr>
        </table>
      </blockquote><br></div>
    ...
    <div id="ParametersWSpan" style="display:block">
      <blockquote>
          ...
          <tr>
            <td valign="top" class="clsSyntaxCells"><b>i2of5minlength:[Value]
													</b></td>
            <td valign="top" class="clsSyntaxCells">Numeric value (0 - 55)</td>
            <td valign="top" class="clsSyntaxCells">Numeric value setting the minimum number of characters for the i2of5 structure (0 - 55).</td>
...
The i2of5MinLength META Tag is an action tag used to set the i2of5 MinLength property.
--&gt;

&lt;!-- &lt;META HTTP-Equiv="Scanner" Content="i2of5minlength:[Value]"&gt; --&gt;      &lt;!-- Numeric value setting the minimum number of characters for the i2of5 structure (0 - 55). --&gt;</textarea></div>
        <div style="display:none"><textarea id="txtJavascriptTemplateW">&lt;script&gt;
   /*
   The i2of5MinLength META Tag is an action tag used to set the i2of5 MinLength property.
   */

   function doi2of5MinLengthInit()
   {
      var objGeneric = new ActiveXObject("PocketBrowser.Generic");

      //objGeneric.InvokeMETAFunction('Scanner', 'i2of5minlength:[Value]');      /* Numeric value setting the minimum number of characters for the i2of5 structure (0 - 55). */
...
&lt;/script&gt;</textarea></div>
    ...
    <div id="ExamplesSpan" style="display:block">
      <blockquote>
        <p>The following example enables the scanner to read only i2of5 labels with the MinLength property set to 30:</p>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <td>
