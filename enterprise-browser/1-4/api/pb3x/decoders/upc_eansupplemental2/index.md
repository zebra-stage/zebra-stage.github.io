...
﻿<html>
  <head>
    ...
    <title>upc_eansupplemental2</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    <table width="100%">
      <tr>
        <td valign="middle" width="95%">
          <h1>upc_eansupplemental2 META Tag</h1>
        </td>
    ...
    <p>
					The 
					<b>upc_eansupplemental2</b> META Tag is an action tag used to enable or disable upc_ean-supplemental2 supplemental barcodes.</p>
    ...
    <div id="SyntaxSpan" style="display:block">
      <blockquote>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <th class="clsSyntaxHeadings">upc_eansupplemental2 (META Tag) Syntax
						</th>
          </tr>
          <tr>
            <td class="clsSyntaxCells">
              <p>&lt;META HTTP-Equiv="scanner" content="upc_eansupplemental2:[parameter]"&gt;</p>
            </td>
          </tr>
        </table>
      </blockquote><br></div>
    ...
    <div id="ParametersWSpan" style="display:block">
      <blockquote>
          ...
          <tr>
            <td valign="top" class="clsSyntaxCells"><b>upc_eansupplemental2:[Value]
													</b></td>
...
&lt;!-- &lt;META HTTP-Equiv="Scanner" Content="upc_eansupplemental2:[Value]"&gt; --&gt;      &lt;!-- Enables/disables the supplemental barcode decoding. --&gt;</textarea></div>
        <div style="display:none"><textarea id="txtJavascriptTemplateW">&lt;script&gt;
   /*
   The upc_eansupplemental2 META Tag is an action tag used to enable or disable upc_ean-supplemental2 supplemental barcodes.
   */

   function doupc_eansupplemental2Init()
   {
      var objGeneric = new ActiveXObject("PocketBrowser.Generic");

      //objGeneric.InvokeMETAFunction('Scanner', 'upc_eansupplemental2:[Value]');      /* Enables/disables the supplemental barcode decoding. */
...
&lt;/script&gt;</textarea></div>
    ...
    <div id="ExamplesSpan" style="display:block">
      <blockquote>
        <p>The following example enables the scanner to decode upc_ean-supplemental2 barcodes:</p>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <td>
...
&lt;META HTTP-Equiv="Scanner" Content="upc_eansupplemental2:true"&gt;
...
The following example enables the scanner to decode upc_ean-supplemental2 barcodes:
--&gt;
...
&lt;META HTTP-Equiv="scanner" Content="enabled"&gt;
        ...
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <td>
              <pre class="clsSyntaxCells">
&lt;META HTTP-Equiv="Scanner" Content="all_decoders:enabled;upc_eansupplementalmode:always;upc_eansupplemental2:true;enabled"&gt;
</pre>
            </td>
          </tr>
        </table>
...
&lt;META HTTP-Equiv="Scanner-upc_ean-supplementalmode" Content="always"&gt;   
&lt;META HTTP-Equiv="Scanner-upc_eansupplemental2" Content="true"&gt;
