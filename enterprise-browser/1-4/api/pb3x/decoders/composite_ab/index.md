...
﻿<html>
  <head>
    ...
    <title>Composit_ab</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    ...
    <p>
					The 
					<b>Composit_ab</b> META Tag is an action tag used to enable or disable the Composit_ab decoder.</p>
    ...
    <div id="SyntaxSpan" style="display:block">
      <blockquote>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <th class="clsSyntaxHeadings">Composit_ab (META Tag) Syntax
						</th>
          </tr>
          <tr>
            <td class="clsSyntaxCells">
              <p>&lt;META HTTP-Equiv="scanner" content="Composit_ab:[parameter]"&gt;</p>
            </td>
          </tr>
        </table>
      </blockquote><br></div>
    ...
    <div id="ParametersWSpan" style="display:block">
      <blockquote>
          ...
          <tr>
            <td valign="top" class="clsSyntaxCells"><b>Composit_ab:[Value]
													</b></td>
            <td valign="top" class="clsSyntaxCells">enabled/disabled</td>
            <td valign="top" class="clsSyntaxCells">Enables/disables Composit_ab decoder.</td>
...
The Composit_ab META Tag is an action tag used to enable or disable the Composit_ab decoder.
--&gt;

&lt;!-- &lt;META HTTP-Equiv="Scanner" Content="Composit_ab:[Value]"&gt; --&gt;      &lt;!-- Enables/disables Composit_ab decoder. --&gt;</textarea></div>
        <div style="display:none"><textarea id="txtJavascriptTemplateW">&lt;script&gt;
   /*
   The Composit_ab META Tag is an action tag used to enable or disable the Composit_ab decoder.
   */

   function doComposit_abInit()
   {
      var objGeneric = new ActiveXObject("PocketBrowser.Generic");

      //objGeneric.InvokeMETAFunction('Scanner', 'Composit_ab:[Value]');      /* Enables/disables Composit_ab decoder. */
...
&lt;/script&gt;</textarea></div>
    ...
    <div id="ExamplesSpan" style="display:block">
      <blockquote>
        <p>The following example enables the scanner to read only Composit_ab labels:</p>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <td>
              <pre class="clsSyntaxCells">
&lt;META HTTP-Equiv="scanner" Content="all_decoders:disabled"&gt;
&lt;META HTTP-Equiv="scanner" Content="Composit_ab:enabled"&gt;
...
The following example enables the scanner to read only Composit_ab labels:
--&gt;
...
&lt;META HTTP-Equiv="scanner" Content="enabled"&gt;
        ...
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <td>
              <pre class="clsSyntaxCells">
&lt;META HTTP-Equiv="scanner" Content="all_decoders:disabled;Composit_ab:enabled;enabled"&gt;
</pre>
            </td>
          </tr>
        </table>
...
&lt;META HTTP-Equiv="scanner-Composit_ab" Content="enabled"&gt;
...
&lt;META HTTP-Equiv="scanner" Content="Composit_ab:disabled"&gt;
&lt;META HTTP-Equiv="scanner" Content="enabled"&gt;
</pre>
            </td>
          </tr>
