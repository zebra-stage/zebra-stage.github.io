...
﻿<html>
  <head>
    ...
    <title>msiMinLength</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    ...
    <p>
					The 
					<b>msiMinLength</b> META Tag is an action tag used to set the msi MinLength property.  Setting this property will help prevent partial decoding of barcodes.</p>
    ...
    <div id="SyntaxSpan" style="display:block">
      <blockquote>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <th class="clsSyntaxHeadings">msiMinLength (META Tag) Syntax
						</th>
          </tr>
          <tr>
            <td class="clsSyntaxCells">
              <p>&lt;META HTTP-Equiv="scanner" content="msiminlength:[parameter]"&gt;</p>
            </td>
          </tr>
        </table>
      </blockquote><br></div>
    ...
    <div id="ParametersWSpan" style="display:block">
      <blockquote>
          ...
          <tr>
            <td valign="top" class="clsSyntaxCells"><b>msiminlength:[Value]
													</b></td>
            <td valign="top" class="clsSyntaxCells">Numeric value (0 - 55)</td>
            <td valign="top" class="clsSyntaxCells">Numeric value setting the minimum number of characters for the msi structure (0 - 55).</td>
...
The msiMinLength META Tag is an action tag used to set the msi MinLength property. Setting this property will help prevent partial decoding of barcodes.
--&gt;

&lt;!-- &lt;META HTTP-Equiv="Scanner" Content="msiminlength:[Value]"&gt; --&gt;      &lt;!-- Numeric value setting the minimum number of characters for the msi structure (0 - 55). --&gt;</textarea></div>
        <div style="display:none"><textarea id="txtJavascriptTemplateW">&lt;script&gt;
   /*
   The msiMinLength META Tag is an action tag used to set the msi MinLength property. Setting this property will help prevent partial decoding of barcodes.
   */

   function domsiMinLengthInit()
   {
      var objGeneric = new ActiveXObject("PocketBrowser.Generic");

      //objGeneric.InvokeMETAFunction('Scanner', 'msiminlength:[Value]');      /* Numeric value setting the minimum number of characters for the msi structure (0 - 55). */
...
&lt;/script&gt;</textarea></div>
    ...
    <div id="ExamplesSpan" style="display:block">
      <blockquote>
        <p>The following example enables the scanner to read only msi labels with the MinLength property set to 30:</p>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <td>
...
&lt;META HTTP-Equiv="scanner-enabled" Content="SCN1"&gt;
    ...
    <div id="AlsoSpan" style="display:block">
      <BLOCKQUOTE><a href="../Scanner.html&#xA;						">Scanner</a> <a href="msi.html&#xA;						">msi</a> </BLOCKQUOTE><br></div>
    <hr size="1">
