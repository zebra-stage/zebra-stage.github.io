...
﻿<html>
  <head>
    ...
    <title>upce0ConvertToupca</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    <table width="100%">
      <tr>
        <td valign="middle" width="95%">
          <h1>upce0ConvertToupca META Tag</h1>
        </td>
    ...
    <p>
					The 
					<b>upce0ConvertToupca</b> META Tag is an action tag used to enable conversion from upce0 to upca bar code. If this flag is set, the bar code is converted to upca, and upca parameters are used.</p>
        ...
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          ...
          <tr>
            <td class="clsSyntaxCells">
              <p>&lt;META HTTP-Equiv="scanner" content="upce0ConvertToupca:[parameter]"&gt;</p>
            </td>
          </tr>
        </table>
      </blockquote><br></div>
