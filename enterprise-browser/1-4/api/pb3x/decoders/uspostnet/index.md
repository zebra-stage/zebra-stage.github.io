...
﻿<html>
  <head>
    ...
    <title>uspostnet</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    ...
    <p>
					The 
					<b>uspostnet</b> META Tag is an action tag used to enable or disable the uspostnet decoder.</p>
    ...
    <div id="SyntaxSpan" style="display:block">
      <blockquote>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <th class="clsSyntaxHeadings">uspostnet (META Tag) Syntax
						</th>
          </tr>
          <tr>
            <td class="clsSyntaxCells">
              <p>&lt;META HTTP-Equiv="scanner" content="uspostnet:[parameter]"&gt;</p>
            </td>
          </tr>
        </table>
      </blockquote><br></div>
    ...
    <div id="ParametersWSpan" style="display:block">
      <blockquote>
          ...
          <tr>
            <td valign="top" class="clsSyntaxCells"><b>uspostnet:[Value]
													</b></td>
            <td valign="top" class="clsSyntaxCells">enabled/Disabled</td>
            <td valign="top" class="clsSyntaxCells">Enables/Disables the uspostnet decoder.</td>
...
The uspostnet META Tag is an action tag used to enable or disable the uspostnet decoder.
--&gt;

&lt;!-- &lt;META HTTP-Equiv="Scanner" Content="uspostnet:[Value]"&gt; --&gt;      &lt;!-- Enables/Disables the uspostnet decoder. --&gt;</textarea></div>
        <div style="display:none"><textarea id="txtJavascriptTemplateW">&lt;script&gt;
   /*
   The uspostnet META Tag is an action tag used to enable or disable the uspostnet decoder.
   */

   function douspostnetInit()
   {
      var objGeneric = new ActiveXObject("PocketBrowser.Generic");

      //objGeneric.InvokeMETAFunction('Scanner', 'uspostnet:[Value]');      /* Enables/Disables the uspostnet decoder. */
...
&lt;/script&gt;</textarea></div>
    ...
    <div id="ExamplesSpan" style="display:block">
      <blockquote>
        <p>The following example enables the scanner to read only uspostnet labels:</p>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <td>
...
&lt;META HTTP-Equiv="scanner" Content="enabled"&gt;
        ...
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <td>
              <pre class="clsSyntaxCells">
&lt;META HTTP-Equiv="scanner" Content="all_decoders:disabled;uspostnet:enabled;enabled"&gt;
</pre>
            </td>
          </tr>
        </table>
...
&lt;META HTTP-Equiv="scanner-enabled" Content="SCN1"&gt;
        ...
        <p>The following example enables the scanner to read all labels except uspostnet:</p>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <td>
              <pre class="clsSyntaxCells">
      ...
      <blockquote>
        <table>
          ...
          <tr>
            ...
            <td>Scanner or Imager module and device supports uspostnet.</td>
          </tr>
        </table>
      </blockquote><br></div>
