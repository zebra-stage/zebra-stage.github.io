...
﻿<html>
  <head>
    ...
    <title>upce1ConvertToupca</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    <table width="100%">
      <tr>
        <td valign="middle" width="95%">
          <h1>upce1ConvertToupca META Tag</h1>
        </td>
    ...
    <p>
					The 
					<b>upce1ConvertToupca</b> META Tag is an action tag used to enable conversion from upce1 to upca bar code. If this flag is set, the bar code is converted to upca, and upca parameters are used.</p>
    ...
    <div id="SyntaxSpan" style="display:block">
      <blockquote>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <th class="clsSyntaxHeadings">upce1ConvertToupca (META Tag) Syntax
						</th>
          </tr>
          <tr>
            <td class="clsSyntaxCells">
              <p>&lt;META HTTP-Equiv="scanner" content="upce1ConvertToupca:[parameter]"&gt;</p>
            </td>
          </tr>
        </table>
      </blockquote><br></div>
    ...
    <div id="ParametersWSpan" style="display:block">
      <blockquote>
          ...
          <tr>
            <td valign="top" class="clsSyntaxCells"><b>upce1ConvertToupca:[Value]
													</b></td>
...
&lt;!-- &lt;META HTTP-Equiv="Scanner" Content="upce1ConvertToupca:[Value]"&gt; --&gt;      &lt;!-- Enables/Disables the property. --&gt;</textarea></div>
        <div style="display:none"><textarea id="txtJavascriptTemplateW">&lt;script&gt;
   /*
   The upce1ConvertToupca META Tag is an action tag used to enable conversion from upce1 to upca bar code. If this flag is set, the bar code is converted to upca, and upca parameters are used.
   */

   function doupce1ConvertToupcaInit()
   {
      var objGeneric = new ActiveXObject("PocketBrowser.Generic");

      //objGeneric.InvokeMETAFunction('Scanner', 'upce1ConvertToupca:[Value]');      /* Enables/Disables the property. */
...
&lt;/script&gt;</textarea></div>
    ...
    <div id="ExamplesSpan" style="display:block">
      <blockquote>
        <p>The following example enables the scanner to read only upce1 labels with the ConvertToupca property set:</p>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <td>
      ...
      <blockquote>
        <table>
          ...
          <tr>
            ...
            <td>Scanner or Imager module and device supports upce1 and upca.</td>
          </tr>
        </table>
      </blockquote><br></div>
