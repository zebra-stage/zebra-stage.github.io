...
﻿<html>
  <head>
    ...
    <title>upc_eansupplemental5</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    <table width="100%">
      <tr>
        <td valign="middle" width="95%">
          <h1>upc_eansupplemental5 META Tag</h1>
        </td>
    ...
    <p>
					The 
					<b>upc_eansupplemental5</b> META Tag is an action tag used to enable or disable upc_eansupplemental5 supplemental barcodes.</p>
    ...
    <div id="SyntaxSpan" style="display:block">
      <blockquote>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <th class="clsSyntaxHeadings">upc_eansupplemental5 (META Tag) Syntax
						</th>
          </tr>
          <tr>
            <td class="clsSyntaxCells">
              <p>&lt;META HTTP-Equiv="scanner" content="upc_eansupplemental5:[parameter]"&gt;</p>
            </td>
          </tr>
        </table>
      </blockquote><br></div>
    ...
    <div id="ParametersWSpan" style="display:block">
      <blockquote>
          ...
          <tr>
            <td valign="top" class="clsSyntaxCells"><b>upc_eansupplemental5:[Value]
													</b></td>
            <td valign="top" class="clsSyntaxCells">true/false</td>
            <td valign="top" class="clsSyntaxCells">Enables/Disables the supplemental barcode decoding.</td>
...
The upc_eansupplemental5 META Tag is an action tag used to enable or disable upc_eansupplemental5 supplemental barcodes.
--&gt;

&lt;!-- &lt;META HTTP-Equiv="Scanner" Content="upc_eansupplemental5:[Value]"&gt; --&gt;      &lt;!-- Enables/Disables the supplemental barcode decoding. --&gt;</textarea></div>
        <div style="display:none"><textarea id="txtJavascriptTemplateW">&lt;script&gt;
   /*
   The upc_eansupplemental5 META Tag is an action tag used to enable or disable upc_eansupplemental5 supplemental barcodes.
   */

   function doupc_eansupplemental5Init()
   {
      var objGeneric = new ActiveXObject("PocketBrowser.Generic");

      //objGeneric.InvokeMETAFunction('Scanner', 'upc_eansupplemental5:[Value]');      /* Enables/Disables the supplemental barcode decoding. */
...
&lt;/script&gt;</textarea></div>
    ...
    <div id="ExamplesSpan" style="display:block">
      <blockquote>
        <p>The following example enables the scanner to decode upc_ean-supplemental5 barcodes:</p>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <td>
...
&lt;META HTTP-Equiv="scanner" Content="upc_eansupplemental5:true"&gt;
...
The following example enables the scanner to decode upc_ean-supplemental5 barcodes:
--&gt;
...
&lt;META HTTP-Equiv="scanner" Content="enabled"&gt;
        ...
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <td>
              <pre class="clsSyntaxCells">
&lt;META HTTP-Equiv="scanner" Content="all_decoders:enabled;upc_eansupplementalmode:always;upc_eansupplemental5:true;enabled"&gt;
</pre>
            </td>
          </tr>
        </table>
...
&lt;META HTTP-Equiv="scanner-upc_eansupplemental5" Content="true"&gt;
...
&lt;META HTTP-Equiv="scanner-enabled" Content="SCN1"&gt;
    ...
    <div id="AlsoSpan" style="display:block">
      <BLOCKQUOTE><a href="../Scanner.html&#xA;						">Scanner</a> <a href="upc_ean-supplementalmode.html&#xA;						">upc_ean-supplementalmode</a> <a href="All_Decoders.html&#xA;						">All_Decoders</a> </BLOCKQUOTE><br></div>
    <hr size="1">
