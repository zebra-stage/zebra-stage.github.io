...
﻿<html>
  <head>
    ...
    <title>Webcode</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    ...
    <p>
					The 
					<b>Webcode</b> META Tag is an action tag used to enable or disable the Webcode decoder.</p>
    ...
    <div id="SyntaxSpan" style="display:block">
      <blockquote>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <th class="clsSyntaxHeadings">Webcode (META Tag) Syntax
						</th>
          </tr>
          <tr>
            <td class="clsSyntaxCells">
              <p>&lt;META HTTP-Equiv="scanner" content="Webcode:[parameter]"&gt;</p>
            </td>
          </tr>
        </table>
      </blockquote><br></div>
    ...
    <div id="ParametersWSpan" style="display:block">
      <blockquote>
          ...
          <tr>
            <td valign="top" class="clsSyntaxCells"><b>Webcode:[Value]
													</b></td>
            <td valign="top" class="clsSyntaxCells">enabled/Disabled</td>
            <td valign="top" class="clsSyntaxCells">Enables/Disables the Webcode decoder.</td>
...
The Webcode META Tag is an action tag used to enable or disable the Webcode decoder.
--&gt;

&lt;!-- &lt;META HTTP-Equiv="Scanner" Content="Webcode:[Value]"&gt; --&gt;      &lt;!-- Enables/Disables the Webcode decoder. --&gt;</textarea></div>
        <div style="display:none"><textarea id="txtJavascriptTemplateW">&lt;script&gt;
   /*
   The Webcode META Tag is an action tag used to enable or disable the Webcode decoder.
   */

   function doWebcodeInit()
   {
      var objGeneric = new ActiveXObject("PocketBrowser.Generic");

      //objGeneric.InvokeMETAFunction('Scanner', 'Webcode:[Value]');      /* Enables/Disables the Webcode decoder. */
      ...
      <blockquote>
        <table>
          ...
          <tr>
            ...
            <td>Scanner or Imager module and device supports Webcode.</td>
          </tr>
        </table>
      </blockquote><br></div>
