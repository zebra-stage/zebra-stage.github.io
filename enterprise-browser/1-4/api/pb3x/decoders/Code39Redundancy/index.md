...
﻿<html>
  <head>
    ...
    <title>Code39Redundancy</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    <table width="100%">
      <tr>
        <td valign="middle" width="95%">
          <h1>Code39Redundancy META Tag</h1>
        </td>
    ...
    <p>
					The 
					<b>Code39Redundancy</b> META Tag 	is an action tag used to set the Code39 Redundancy property. If this flag is set, the bar code must be decoded twice before being accepted.</p>
    ...
    <div id="SyntaxSpan" style="display:block">
      <blockquote>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <th class="clsSyntaxHeadings">Code39Redundancy (META Tag) Syntax
						</th>
          </tr>
          <tr>
            <td class="clsSyntaxCells">
              <p>&lt;META HTTP-Equiv="scanner" content="Code39Redundancy:[parameter]"&gt;</p>
            </td>
          </tr>
        </table>
      </blockquote><br></div>
    ...
    <div id="ParametersWSpan" style="display:block">
      <blockquote>
          ...
          <tr>
            <td valign="top" class="clsSyntaxCells"><b>Code39Redundancy:[Value]
													</b></td>
...
The Code39Redundancy META Tag is an action tag used to set the Code39 Redundancy property. If this flag is set, the bar code must be decoded twice before being accepted.
--&gt;

&lt;!-- &lt;META HTTP-Equiv="Scanner" Content="Code39Redundancy:[Value]"&gt; --&gt;      &lt;!-- Enables/Disables the property. --&gt;</textarea></div>
        <div style="display:none"><textarea id="txtJavascriptTemplateW">&lt;script&gt;
   /*
   The Code39Redundancy META Tag is an action tag used to set the Code39 Redundancy property. If this flag is set, the bar code must be decoded twice before being accepted.
   */

   function doCode39RedundancyInit()
   {
      var objGeneric = new ActiveXObject("PocketBrowser.Generic");

      //objGeneric.InvokeMETAFunction('Scanner', 'Code39Redundancy:[Value]');      /* Enables/Disables the property. */
...
&lt;/script&gt;</textarea></div>
    ...
    <div id="ExamplesSpan" style="display:block">
      <blockquote>
        <p>The following example enables the scanner to read only Code39 labels with the Redundancy property set</p>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <td>
