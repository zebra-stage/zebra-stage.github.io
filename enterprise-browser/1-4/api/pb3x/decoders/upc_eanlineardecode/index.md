...
﻿<html>
  <head>
    ...
    <title>upc_eanlineardecode</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    <table width="100%">
      <tr>
        <td valign="middle" width="95%">
          <h1>upc_eanlineardecode META Tag</h1>
        </td>
    ...
    <p>
					The 
					<b>upc_eanlineardecode</b> META Tag is an action tag used to enable the linear decode property.</p>
    ...
    <div id="SyntaxSpan" style="display:block">
      <blockquote>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <th class="clsSyntaxHeadings">upc_eanlineardecode (META Tag) Syntax
						</th>
          </tr>
          <tr>
    ...
    <div id="ParametersWSpan" style="display:block">
      <blockquote>
          ...
          <tr>
            <td valign="top" class="clsSyntaxCells"><b>upc_eanlineardecode:[Value]
													</b></td>
            <td valign="top" class="clsSyntaxCells">true/false</td>
            <td valign="top" class="clsSyntaxCells">Sets the linear decode property to 'true' or 'false'.</td>
...
The upc_eanlineardecode META Tag is an action tag used to enable the linear decode property.
--&gt;

&lt;!-- &lt;META HTTP-Equiv="Scanner" Content="upc_eanlineardecode:[Value]"&gt; --&gt;      &lt;!-- Sets the linear decode property to 'true' or 'false'. --&gt;</textarea></div>
        <div style="display:none"><textarea id="txtJavascriptTemplateW">&lt;script&gt;
   /*
   The upc_eanlineardecode META Tag is an action tag used to enable the linear decode property.
   */

   function doupc_eanlineardecodeInit()
   {
      var objGeneric = new ActiveXObject("PocketBrowser.Generic");

      //objGeneric.InvokeMETAFunction('Scanner', 'upc_eanlineardecode:[Value]');      /* Sets the linear decode property to 'true' or 'false'. */
...
&lt;/script&gt;</textarea></div>
    ...
    <div id="ExamplesSpan" style="display:block">
      <blockquote>
        <p>The following example switches on the upc_ean-lineardecode property:</p>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <td>
              <pre class="clsSyntaxCells">
&lt;META HTTP-Equiv="scanner" Content="all_decoders:enabled"&gt;
&lt;META HTTP-Equiv="scanner" Content="upc_eanlineardecode:true"&gt;
...
The following example switches on the upc_ean-lineardecode property:
--&gt;
...
&lt;META HTTP-Equiv="scanner" Content="enabled"&gt;
        ...
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <td>
              <pre class="clsSyntaxCells">
&lt;META HTTP-Equiv="scanner" Content="all_decoders:enabled;upc_eanlineardecode:true;enabled"&gt;
</pre>
            </td>
          </tr>
        </table>
...
&lt;META HTTP-Equiv="scanner-upc_eanlineardecode" Content="true"&gt;
