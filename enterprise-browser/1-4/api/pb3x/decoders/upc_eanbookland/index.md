...
﻿<html>
  <head>
    ...
    <title>upc_eanbookland</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    <table width="100%">
      <tr>
        <td valign="middle" width="95%">
          <h1>upc_eanbookland META Tag</h1>
        </td>
    ...
    <p>
					The 
					<b>upc_eanbookland</b> META Tag is an action tag used to enable or disable decoding of upc_ean-bookland barcodes.</p>
    ...
    <div id="SyntaxSpan" style="display:block">
      <blockquote>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <th class="clsSyntaxHeadings">upc_eanbookland (META Tag) Syntax
						</th>
          </tr>
          <tr>
    ...
    <div id="ParametersWSpan" style="display:block">
      <blockquote>
          ...
          <tr>
            <td valign="top" class="clsSyntaxCells"><b>upc_eanbookland:[Value]
													</b></td>
            <td valign="top" class="clsSyntaxCells">true/false</td>
            <td valign="top" class="clsSyntaxCells">Enables/Disables Bookland code decoding.</td>
...
&lt;!-- &lt;META HTTP-Equiv="Scanner" Content="upc_eanbookland:[Value]"&gt; --&gt;      &lt;!-- Enables/Disables Bookland code decoding. --&gt;</textarea></div>
        <div style="display:none"><textarea id="txtJavascriptTemplateW">&lt;script&gt;
   /*
   The upc_eanbookland META Tag is an action tag used to enable or disable decoding of upc_ean-bookland barcodes.
   */

   function doupc_eanbooklandInit()
   {
      var objGeneric = new ActiveXObject("PocketBrowser.Generic");

      //objGeneric.InvokeMETAFunction('Scanner', 'upc_eanbookland:[Value]');      /* Enables/Disables Bookland code decoding. */
...
&lt;/script&gt;</textarea></div>
    ...
    <div id="ExamplesSpan" style="display:block">
      <blockquote>
        <p>The following example enables the scanner to decode upc_ean-bookland barcodes:</p>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <td>
              <pre class="clsSyntaxCells">
&lt;META HTTP-Equiv="scanner" Content="all_decoders:enabled"&gt;
&lt;META HTTP-Equiv="scanner" Content="upc_eanbookland:true"&gt;
...
The following example enables the scanner to decode upc_ean-bookland barcodes:
--&gt;
...
&lt;META HTTP-Equiv="scanner" Content="enabled"&gt;
        ...
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <td>
              <pre class="clsSyntaxCells">
&lt;META HTTP-Equiv="scanner" Content="all_decoders:enabled;upc_eanbookland:true;enabled"&gt;
</pre>
            </td>
          </tr>
        </table>
...
&lt;META HTTP-Equiv="scanner-upc_eanbookland" Content="true"&gt;
...
&lt;META HTTP-Equiv="scanner-enabled" Content="SCN1"&gt;
        ...
        <p>The following example disables the scanner from decoding upc_ean-bookland barcodes:</p>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <td>
              <pre class="clsSyntaxCells">
&lt;META HTTP-Equiv="scanner" Content="all_decoders:enabled"&gt;
&lt;META HTTP-Equiv="scanner" Content="upc_ean-bookland:false"&gt;
&lt;META HTTP-Equiv="scanner" Content="enabled"&gt;
</pre>
            </td>
          </tr>
...
The following example disables the scanner from decoding upc_ean-bookland barcodes:
--&gt;
