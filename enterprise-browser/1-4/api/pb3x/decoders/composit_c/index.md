...
﻿<html>
  <head>
    ...
    <title>Composit_c</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    ...
    <p>
					The 
					<b>Composit_c</b> META Tag is an action tag used to enable or disable the Composit_c decoder.</p>
    ...
    <div id="SyntaxSpan" style="display:block">
      <blockquote>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <th class="clsSyntaxHeadings">Composit_c (META Tag) Syntax
						</th>
          </tr>
          <tr>
    ...
    <div id="ParametersWSpan" style="display:block">
      <blockquote>
          ...
          <tr>
            <td valign="top" class="clsSyntaxCells"><b>Composit_c:[Value]
													</b></td>
            <td valign="top" class="clsSyntaxCells">enabled/Disabled</td>
            <td valign="top" class="clsSyntaxCells">Enables/Disables the Composit_c decoder.</td>
...
The Composit_c META Tag is an action tag used to enable or disable the Composit_c decoder.
--&gt;

&lt;!-- &lt;META HTTP-Equiv="Scanner" Content="Composit_c:[Value]"&gt; --&gt;      &lt;!-- Enables/Disables the Composit_c decoder. --&gt;</textarea></div>
        <div style="display:none"><textarea id="txtJavascriptTemplateW">&lt;script&gt;
   /*
   The Composit_c META Tag is an action tag used to enable or disable the Composit_c decoder.
   */

   function doComposit_cInit()
   {
      var objGeneric = new ActiveXObject("PocketBrowser.Generic");

      //objGeneric.InvokeMETAFunction('Scanner', 'Composit_c:[Value]');      /* Enables/Disables the Composit_c decoder. */
...
&lt;/script&gt;</textarea></div>
    ...
    <div id="ExamplesSpan" style="display:block">
      <blockquote>
        <p>The following example enables the scanner to read only Webcode labels:</p>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <td>
              <pre class="clsSyntaxCells">
&lt;META HTTP-Equiv="scanner" Content="all_decoders:disabled"&gt;
&lt;META HTTP-Equiv="scanner" Content="Composit_c:enabled"&gt;
...
&lt;META HTTP-Equiv="scanner" Content="enabled"&gt;
        ...
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <td>
              <pre class="clsSyntaxCells">
&lt;META HTTP-Equiv="scanner" Content="all_decoders:disabled;Composit_c:enabled;enabled"&gt;
</pre>
            </td>
          </tr>
        </table>
...
&lt;META HTTP-Equiv="scanner-Composit_c" Content="disabled"&gt;
      ...
      <blockquote>
        <table>
          ...
          <tr>
            ...
            <td>Scanner or Imager module and device supports Composit_c.</td>
          </tr>
        </table>
      </blockquote><br></div>
