...
﻿<html>
  <head>
    ...
    <title>ean8ConvertToEAN13</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    <table width="100%">
      <tr>
        <td valign="middle" width="95%">
          <h1>ean8ConvertToEAN13 META Tag</h1>
        </td>
    ...
    <p>
					The 
					<b>ean8ConvertToEAN13</b> META Tag is an action tag used to enable conversion from ean8 to EAN13 bar code. If this flag is set, the bar code is converted to EAN13, and EAN13 parameters are used.</p>
