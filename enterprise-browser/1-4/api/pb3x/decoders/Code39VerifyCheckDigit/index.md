---
title: Code39VerifyCheckDigit.md
productversion: '1.4'
...
﻿<html>
  <head>
    ...
    <title>Code39VerifyCheckDigit</title><script type="text/javascript" language="Javascript">
  ...
  <body topmargin="0" leftmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff" text="#000000">
    <table width="100%">
      <tr>
        <td valign="middle" width="95%">
          <h1>Code39VerifyCheckDigit META Tag</h1>
        </td>
    ...
    <p>
					The 
					<b>Code39VerifyCheckDigit</b> META Tag is an action tag used to set the Code39 VerifyCheckDigit property which enables verification of the bar code check digit.</p>
    ...
    <div id="SyntaxSpan" style="display:block">
      <blockquote>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <th class="clsSyntaxHeadings">Code39VerifyCheckDigit (META Tag) Syntax
						</th>
          </tr>
          <tr>
            <td class="clsSyntaxCells">
              <p>&lt;META HTTP-Equiv="scanner" content="Code39VerifyCheckDigit:[parameter]"&gt;</p>
            </td>
          </tr>
        </table>
      </blockquote><br></div>
    ...
    <div id="ParametersWSpan" style="display:block">
      <blockquote>
          ...
          <tr>
            <td valign="top" class="clsSyntaxCells"><b>Code39VerifyCheckDigit:[Value]
													</b></td>
            <td valign="top" class="clsSyntaxCells">true/false</td>
            <td valign="top" class="clsSyntaxCells">Enables/Disables verification of the check digit.</td>
...
The Code39VerifyCheckDigit META Tag is an action tag used to set the Code39 VerifyCheckDigit property which enables verification of the bar code check digit.
--&gt;

&lt;!-- &lt;META HTTP-Equiv="Scanner" Content="Code39VerifyCheckDigit:[Value]"&gt; --&gt;      &lt;!-- Enables/Disables verification of the check digit. --&gt;</textarea></div>
        <div style="display:none"><textarea id="txtJavascriptTemplateW">&lt;script&gt;
   /*
   The Code39VerifyCheckDigit META Tag is an action tag used to set the Code39 VerifyCheckDigit property which enables verification of the bar code check digit.
   */

   function doCode39VerifyCheckDigitInit()
   {
      var objGeneric = new ActiveXObject("PocketBrowser.Generic");

      //objGeneric.InvokeMETAFunction('Scanner', 'Code39VerifyCheckDigit:[Value]');      /* Enables/Disables verification of the check digit. */
...
&lt;/script&gt;</textarea></div>
    ...
    <div id="ExamplesSpan" style="display:block">
      <blockquote>
        <p>The following example enables the scanner to read only Code39 labels with the VerifyCheckDigit property set:</p>
        <table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
          <tr>
            <td>
