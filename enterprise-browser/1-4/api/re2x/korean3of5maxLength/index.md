...
<table class="re-table"><tr><th class="tableHeading">Korean3of5maxLength Ruby Object Syntax:</th></tr><tr><td class="clsSyntaxCells clsOddRow">
By default the Ruby Object <b>'Scanner'</b> will exist on the current page and can be used to interact directly with the Korean3of5maxLength.
</td></tr><tr><td class="clsSyntaxCells clsEvenRow">
