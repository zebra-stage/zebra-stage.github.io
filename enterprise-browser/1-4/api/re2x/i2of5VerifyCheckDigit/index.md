...
<table class="re-table"><tr><th class="tableHeading">I2of5verifyCheckDigit Ruby Object Syntax:</th></tr><tr><td class="clsSyntaxCells clsOddRow">
By default the Ruby Object <b>'Scanner'</b> will exist on the current page and can be used to interact directly with the I2of5verifyCheckDigit.
</td></tr><tr><td class="clsSyntaxCells clsEvenRow">
