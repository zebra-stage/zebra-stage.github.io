...
<table class="re-table"><tr><th class="tableHeading">Code93maxLength Ruby Object Syntax:</th></tr><tr><td class="clsSyntaxCells clsOddRow">
By default the Ruby Object <b>'Scanner'</b> will exist on the current page and can be used to interact directly with the Code93maxLength.
</td></tr><tr><td class="clsSyntaxCells clsEvenRow">
To Set Code93maxLength parameters via Ruby use the following syntax: Scanner.Parameter = Value
<P />e.g. <b>Scanner</b>.code93maxLength = Value
</td></tr></table>
