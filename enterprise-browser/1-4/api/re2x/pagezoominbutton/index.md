...
<table class="re-table"><tr><th class="tableHeading">ZoomInPageButton Ruby Object Syntax:</th></tr><tr><td class="clsSyntaxCells clsOddRow">
By default the Ruby Object <b>'ZoomInPageButton'</b> will exist on the current page and can be used to interact directly with the ZoomInPageButton. All Methods, Parameters and Events are the same as JavaScript, however, notice <b>'ZoomInPageButton'</b> needs to start with an uppercase letter. Another difference in Ruby is that methods do not end in <b>'()'</b></td></tr><tr><td class="clsSyntaxCells clsEvenRow">
To Set ZoomInPageButton parameters via Ruby use the following syntax: ZoomInPageButton.parameter = 'value' remembering to enclose your value in quotes where appropriate.  
<P />e.g. <b>ZoomInPageButton</b>.left = 'value'
