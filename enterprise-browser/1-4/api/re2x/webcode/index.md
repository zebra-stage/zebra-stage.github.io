...
<table class="re-table"><tr><th class="tableHeading">Webcode Ruby Object Syntax:</th></tr><tr><td class="clsSyntaxCells clsOddRow">
By default the Ruby Object <b>'Scanner'</b> will exist on the current page and can be used to interact directly with the Webcode.
</td></tr><tr><td class="clsSyntaxCells clsEvenRow">
To Set Webcode parameters via Ruby use the following syntax: Scanner.Parameter = Value
<P />e.g. <b>Scanner</b>.webcode = Value
</td></tr></table>
