...
<table class="re-table"><tr><th class="tableHeading">Code39convertToCode32 Ruby Object Syntax:</th></tr><tr><td class="clsSyntaxCells clsOddRow">
By default the Ruby Object <b>'Scanner'</b> will exist on the current page and can be used to interact directly with the Code39convertToCode32.
</td></tr><tr><td class="clsSyntaxCells clsEvenRow">
To Set Code39convertToCode32 parameters via Ruby use the following syntax: Scanner.Parameter = Value
<P />e.g. <b>Scanner</b>.code39convertToCode32 = Value
</td></tr></table>
