...
<tr>
<th class="clsSyntaxHeadings">Code128EAN128 (META Tag) Syntax
</th>
</tr>
<tr>
...
<tr>
<td valign="top" class="clsSyntaxCells"><b>code128ean128:[Value]
							</b></td>
<td valign="top" class="clsSyntaxCells">true/false</td>
<td valign="top" class="clsSyntaxCells">Enables the EAN128 subtype.</td>
...
&lt;!-- &lt;META HTTP-Equiv="Scanner" Content="code128ean128:[Value]"&gt; --&gt;      &lt;!-- Enables the EAN128 subtype. --&gt;</textarea></div>
<div style="display:none"><textarea id="txtJavascriptTemplateW">&lt;script&gt;
/*
The Code128EAN128 META Tag is an action tag used to set the code128-ean128 property to enable the EAN128 subtype.
*/

function doCode128EAN128Init()
{
var objGeneric = new ActiveXObject("PocketBrowser.Generic");

//objGeneric.InvokeMETAFunction('Scanner', 'code128ean128:[Value]');      /* Enables the EAN128 subtype. */
...
<blockquote>
<p>The following example enables the scanner to read only codabar labels with the EAN128 subtype property set</p>
<table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
<tr>
<td>
