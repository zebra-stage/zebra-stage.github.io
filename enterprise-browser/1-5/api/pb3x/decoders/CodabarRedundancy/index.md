---
title: CodabarRedundancy Meta Tag
productversion: '1.5'
...
The CodabarRedundancy Meta Tag is an action tag used to set the Codabar Redundancy property. If this flag is set, the bar code must be decoded twice before being accepted.

<div id="SyntaxSpan" style="display:block">
<blockquote>
<table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
<tr>
<th class="clsSyntaxHeadings">CodabarRedundancy (META Tag) Syntax
</th>
</tr>
<tr>
<td class="clsSyntaxCells">
<pre class="clsSyntaxCells">&lt;META HTTP-Equiv="scanner" content="CodabarRedundancy:[parameter&gt;</pre>
</td>
</tr>
</table>
</blockquote><br></div>
...
<tr>
<td valign="top" class="clsSyntaxCells"><b>CodabarRedundancy:[Value]
					</b></td>
<td valign="top" class="clsSyntaxCells">true/false</td>
<td valign="top" class="clsSyntaxCells">Enables the Codabar Redundancy property.</td>
...
&lt;!-- &lt;META HTTP-Equiv="Scanner" Content="CodabarRedundancy:[Value]"&gt; --&gt;      &lt;!-- Enables the Codabar Redundancy property. --&gt;</textarea></div>
<div style="display:none"><textarea id="txtJavascriptTemplateW">&lt;script&gt;
/*
The CodabarRedundancy META Tag is an action tag used to set the Codabar Redundancy property. If this flag is set, the bar code must be decoded twice before being accepted.
*/

function doCodabarRedundancyInit()
{
var objGeneric = new ActiveXObject("PocketBrowser.Generic");

//objGeneric.InvokeMETAFunction('Scanner', 'CodabarRedundancy:[Value]');      /* Enables the Codabar Redundancy property. */
...
<blockquote>
<p>The following example enables the scanner to read only Codabar labels with the redundancy property set:</p>
<table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
<tr>
<td>
