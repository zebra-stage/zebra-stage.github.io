---
title: Code128Redundancy Meta Tag
productversion: '1.5'
...
The Code128Redundancy Meta Tag is an action tag used to set the Code128 Redundancy property. If this flag is set, the bar code must be decoded twice before being accepted.

<div id="SyntaxSpan" style="display:block">
<blockquote>
<table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
<tr>
<th class="clsSyntaxHeadings">Code128Redundancy (META Tag) Syntax
</th>
</tr>
<tr>
...
<tr>
<td valign="top" class="clsSyntaxCells"><b>Code128Redundancy:[Value]
							</b></td>
...
&lt;!-- &lt;META HTTP-Equiv="Scanner" Content="Code128Redundancy:[Value]"&gt; --&gt;      &lt;!-- Enables/Disables the property. --&gt;</textarea></div>
<div style="display:none"><textarea id="txtJavascriptTemplateW">&lt;script&gt;
/*
The Code128Redundancy META Tag is an action tag used to set the Code128 Redundancy property. If this flag is set, the bar code must be decoded twice before being accepted.
*/

function doCode128RedundancyInit()
{
var objGeneric = new ActiveXObject("PocketBrowser.Generic");

//objGeneric.InvokeMETAFunction('Scanner', 'Code128Redundancy:[Value]');      /* Enables/Disables the property. */
...
<blockquote>
<p>The following example enables the scanner to read only Code128 labels with the Redundancy property set</p>
<table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
<tr>
<td>
