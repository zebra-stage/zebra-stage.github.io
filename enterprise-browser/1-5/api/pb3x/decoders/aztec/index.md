...
The aztec Meta Tag is an action tag used to enable or disable the aztec decoder.

<div id="SyntaxSpan" style="display:block">
<blockquote>
<table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
<tr>
<th class="clsSyntaxHeadings">aztec (META Tag) Syntax
</th>
</tr>
<tr>
<td class="clsSyntaxCells">
<pre class="clsSyntaxCells">&lt;META HTTP-Equiv="scanner" content="aztec:[parameter&gt;</pre>
</td>
</tr>
</table>
</blockquote><br></div>
...
<tr>
<td valign="top" class="clsSyntaxCells"><b>aztec:[Value]
							</b></td>
<td valign="top" class="clsSyntaxCells">enabled/Disabled</td>
<td valign="top" class="clsSyntaxCells">Enables/Disables the aztec decoder.</td>
...
&lt;!-- &lt;META HTTP-Equiv="Scanner" Content="aztec:[Value]"&gt; --&gt;      &lt;!-- Enables/Disables the aztec decoder. --&gt;</textarea></div>
<div style="display:none"><textarea id="txtJavascriptTemplateW">&lt;script&gt;
/*
The aztec META Tag is an action tag used to enable or disable the aztec decoder.
*/

function doaztecInit()
{
var objGeneric = new ActiveXObject("PocketBrowser.Generic");

//objGeneric.InvokeMETAFunction('Scanner', 'aztec:[Value]');      /* Enables/Disables the aztec decoder. */
...
<blockquote>
<p>The following example enables the scanner to read only aztec labels:</p>
<table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
<tr>
<td>
...
<td>
  <pre class="clsSyntaxCells">
&lt;META HTTP-Equiv="scanner" Content="all_decoders:disabled;aztec:enabled;enabled"&gt;
</pre>
</td>
</tr>
</table>
