---
title: Code39ConvertToCode32 Meta Tag
productversion: '1.5'
...
<tr>
<th class="clsSyntaxHeadings">Code39ConvertToCode32 (META Tag) Syntax
</th>
</tr>
<tr>
...
<tr>
<td valign="top" class="clsSyntaxCells"><b>Code39ConvertToCode32:[Value]
						</b></td>
...
The Code39ConvertToCode32 META Tag is an action tag used to enable conversion from Code39 to Code32 bar code. If this flag is set, the bar code is converted to Code32, and Code32 parameters are used.
--&gt;

&lt;!-- &lt;META HTTP-Equiv="Scanner" Content="Code39ConvertToCode32:[Value]"&gt; --&gt;      &lt;!-- Enables/Disables the property. --&gt;</textarea></div>
<div style="display:none"><textarea id="txtJavascriptTemplateW">&lt;script&gt;
/*
The Code39ConvertToCode32 META Tag is an action tag used to enable conversion from Code39 to Code32 bar code. If this flag is set, the bar code is converted to Code32, and Code32 parameters are used.
*/

function doCode39ConvertToCode32Init()
{
var objGeneric = new ActiveXObject("PocketBrowser.Generic");

//objGeneric.InvokeMETAFunction('Scanner', 'Code39ConvertToCode32:[Value]');      /* Enables/Disables the property. */
...
<blockquote>
<p>The following example enables the scanner to read only Code39 labels with the ConvertToCode32 property set:</p>
<table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
<tr>
<td>
