...
The Code128 Meta Tag is an action tag used to enable or disable the Code128 decoder.

<div id="SyntaxSpan" style="display:block">
<blockquote>
<table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
<tr>
<th class="clsSyntaxHeadings">Code128 (META Tag) Syntax
</th>
</tr>
<tr>
...
<tr>
<td valign="top" class="clsSyntaxCells"><b>Code128:[Value]
						</b></td>
<td valign="top" class="clsSyntaxCells">enabled/disabled</td>
<td valign="top" class="clsSyntaxCells">Enables/Disables the Code128 decoder.</td>
...
&lt;!-- &lt;META HTTP-Equiv="Scanner" Content="Code128:[Value]"&gt; --&gt;      &lt;!-- Enables/Disables the Code128 decoder. --&gt;</textarea></div>
<div style="display:none"><textarea id="txtJavascriptTemplateW">&lt;script&gt;
/*
The Code128 META Tag is an action tag used to enable or disable the Code128 decoder.
*/

function doCode128Init()
{
var objGeneric = new ActiveXObject("PocketBrowser.Generic");

//objGeneric.InvokeMETAFunction('Scanner', 'Code128:[Value]');      /* Enables/Disables the Code128 decoder. */
...
<blockquote>
<p>The following example enables the scanner to read only Code128 labels:</p>
<table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
<tr>
<td>
...
<td>
<pre class="clsSyntaxCells">
&lt;META HTTP-Equiv="scanner" Content="all_decoders:disabled;Code128:enabled;enabled"&gt;
</pre>
</td>
</tr>
</table>
...
<p>The following example enables the scanner to read all labels except Code128:</p>
<table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
<tr>
<td>
<pre class="clsSyntaxCells">
