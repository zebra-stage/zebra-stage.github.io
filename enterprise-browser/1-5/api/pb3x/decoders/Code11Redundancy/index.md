---
title: Code11Redundancy Meta Tag
productversion: '1.5'
...
The Code11Redundancy Meta Tag is an action tag used to set the Code11 Redundancy property. If this flag is set, the bar code must be decoded twice before being accepted.

<div id="SyntaxSpan" style="display:block">
<blockquote>
<table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
<tr>
<th class="clsSyntaxHeadings">Code11Redundancy (META Tag) Syntax
</th>
</tr>
<tr>
<td class="clsSyntaxCells">
<pre class="clsSyntaxCells">&lt;META HTTP-Equiv="scanner" content="Code11Redundancy:[parameter&gt;</pre>
</td>
</tr>
</table>
</blockquote><br></div>
...
<tr>
<td valign="top" class="clsSyntaxCells"><b>Code11Redundancy:[Value]
							</b></td>
...
&lt;!-- &lt;META HTTP-Equiv="Scanner" Content="Code11Redundancy:[Value]"&gt; --&gt;      &lt;!-- Enables/disables the property. --&gt;</textarea></div>
<div style="display:none"><textarea id="txtJavascriptTemplateW">&lt;script&gt;
/*
The Code11Redundancy META Tag is an action tag used to set the Code11 Redundancy property. If this flag is set, the bar code must be decoded twice before being accepted.
*/

function doCode11RedundancyInit()
{
var objGeneric = new ActiveXObject("PocketBrowser.Generic");

//objGeneric.InvokeMETAFunction('Scanner', 'Code11Redundancy:[Value]');      /* Enables/disables the property. */
...
<blockquote>
<p>The following example enables the scanner to read only Code11 labels with the Redundancy property set</p>
<table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
<tr>
<td>
