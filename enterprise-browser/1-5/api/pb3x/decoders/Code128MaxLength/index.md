---
title: Code128MaxLength Meta Tag
productversion: '1.5'
...
The Code128MaxLength Meta Tag is an action tag used to set the Code128 MaxLength property.

<div id="SyntaxSpan" style="display:block">
<blockquote>
<table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
<tr>
<th class="clsSyntaxHeadings">Code128MaxLength (META Tag) Syntax
</th>
</tr>
<tr>
...
<tr>
<td valign="top" class="clsSyntaxCells"><b>Code128maxlength:[Value]
							</b></td>
<td valign="top" class="clsSyntaxCells">Numeric value (0 - 55)</td>
<td valign="top" class="clsSyntaxCells">Numeric value setting the maximum number of characters for the Code128 structure (0 - 55).</td>
...
&lt;!-- &lt;META HTTP-Equiv="Scanner" Content="Code128maxlength:[Value]"&gt; --&gt;      &lt;!-- Numeric value setting the maximum number of characters for the Code128 structure (0 - 55). --&gt;</textarea></div>
<div style="display:none"><textarea id="txtJavascriptTemplateW">&lt;script&gt;
/*
The Code128MaxLength META Tag is an action tag used to set the Code128 MaxLength property.
*/

function doCode128MaxLengthInit()
{
var objGeneric = new ActiveXObject("PocketBrowser.Generic");

//objGeneric.InvokeMETAFunction('Scanner', 'Code128maxlength:[Value]');      /* Numeric value setting the maximum number of characters for the Code128 structure (0 - 55). */
...
<blockquote>
<p>The following example enables the scanner to read only Code128 labels with the MaxLength property set to 30:</p>
<table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
<tr>
<td>
