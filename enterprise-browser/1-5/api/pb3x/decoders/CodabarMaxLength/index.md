---
title: CodabarMaxLength Meta Tag
productversion: '1.5'
...
The CodabarMaxLength Meta Tag is an action tag used to set the Codabar MaxLength property.

﻿    <div id="SyntaxSpan" style="display:block">
<blockquote>
<table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
<tr>
<th class="clsSyntaxHeadings">CodabarMaxLength (META Tag) Syntax
</th>
</tr>
<tr>
...
<tr>
<td valign="top" class="clsSyntaxCells"><b>Codabarmaxlength:[Value]
							</b></td>
<td valign="top" class="clsSyntaxCells">Numeric value (0 - 55)</td>
<td valign="top" class="clsSyntaxCells">Numeric value setting the maximum number of characters for the Codabar structure (0 - 55).</td>
...
&lt;!-- &lt;META HTTP-Equiv="Scanner" Content="Codabarmaxlength:[Value]"&gt; --&gt;      &lt;!-- Numeric value setting the maximum number of characters for the Codabar structure (0 - 55). --&gt;</textarea></div>
<div style="display:none"><textarea id="txtJavascriptTemplateW">&lt;script&gt;
/*
The CodabarMaxLength META Tag is an action tag used to set the Codabar MaxLength property.
*/

function doCodabarMaxLengthInit()
{
var objGeneric = new ActiveXObject("PocketBrowser.Generic");

//objGeneric.InvokeMETAFunction('Scanner', 'Codabarmaxlength:[Value]');      /* Numeric value setting the maximum number of characters for the Codabar structure (0 - 55). */
...
<blockquote>
<p>The following example enables the scanner to read only Codabar labels with the MaxLength property set to 30:</p>
<table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
<tr>
<td>
