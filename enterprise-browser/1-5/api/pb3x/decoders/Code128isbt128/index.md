...
The Code128isbt128 Meta Tag is an action tag used to set the code128-isbt128 property to enable the isbt128 subtype.

﻿    <div id="SyntaxSpan" style="display:block">
<blockquote>
<table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
<tr>
<th class="clsSyntaxHeadings">Code128isbt128 (META Tag) Syntax
</th>
</tr>
<tr>
<td class="clsSyntaxCells">
<pre class="clsSyntaxCells">&lt;META HTTP-Equiv="scanner" content="code128isbt128:[parameter&gt;</pre>
</td>
</tr>
</table>
</blockquote><br></div>
...
<tr>
<td valign="top" class="clsSyntaxCells"><b>code128isbt128:[Value]
					</b></td>
<td valign="top" class="clsSyntaxCells">true/false</td>
<td valign="top" class="clsSyntaxCells">Enables/disables the isbt128 subtype.</td>
...
&lt;!-- &lt;META HTTP-Equiv="Scanner" Content="code128isbt128:[Value]"&gt; --&gt;      &lt;!-- Enables/disables the isbt128 subtype. --&gt;</textarea></div>
<div style="display:none"><textarea id="txtJavascriptTemplateW">&lt;script&gt;
/*
The Code128isbt128 META Tag is an action tag used to set the code128-isbt128 property to enable the isbt128 subtype.
*/

function doCode128isbt128Init()
{
var objGeneric = new ActiveXObject("PocketBrowser.Generic");

//objGeneric.InvokeMETAFunction('Scanner', 'code128isbt128:[Value]');      /* Enables/disables the isbt128 subtype. */
...
<blockquote>
<p>The following example enables the scanner to read only codabar labels with the isbt128 subtype property set</p>
<table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
<tr>
<td>
