---
title: CodabarMinLength Meta Tag
productversion: '1.5'
...
The CodabarMinLength Meta Tag is an action tag used to set the Codabar MinLength property.

﻿    <div id="SyntaxSpan" style="display:block">
<blockquote>
<table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
<tr>
<th class="clsSyntaxHeadings">CodabarMinLength (META Tag) Syntax
</th>
</tr>
<tr>
<td class="clsSyntaxCells">
<pre class="clsSyntaxCells">&lt;META HTTP-Equiv="scanner" content="Codabarminlength:[parameter&gt;</pre>
</td>
</tr>
</table>
</blockquote><br></div>
...
<tr>
<td valign="top" class="clsSyntaxCells"><b>Codabarminlength:[Value]
							</b></td>
<td valign="top" class="clsSyntaxCells">Numeric value (0 - 55)</td>
<td valign="top" class="clsSyntaxCells">Numeric value setting the minimum number of characters for the Codabar structure (0 - 55).</td>
...
&lt;!-- &lt;META HTTP-Equiv="Scanner" Content="Codabarminlength:[Value]"&gt; --&gt;      &lt;!-- Numeric value setting the minimum number of characters for the Codabar structure (0 - 55). --&gt;</textarea></div>
<div style="display:none"><textarea id="txtJavascriptTemplateW">&lt;script&gt;
/*
The CodabarMinLength META Tag is an action tag used to set the Codabar MinLength property.
*/

function doCodabarMinLengthInit()
{
var objGeneric = new ActiveXObject("PocketBrowser.Generic");

//objGeneric.InvokeMETAFunction('Scanner', 'Codabarminlength:[Value]');      /* Numeric value setting the minimum number of characters for the Codabar structure (0 - 55). */
...
<blockquote>
<p>The following example enables the scanner to read only Codabar labels with the MinLength property set to 30:</p>
<table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
<tr>
<td>
