---
title: Code39concatenation Meta Tag
productversion: '1.5'
...
The Code39concatenation Meta Tag is an action tag used to set the Code39concatenation property.
 
<div id="SyntaxSpan" style="display:block">
<blockquote>
<table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
<tr>
<th class="clsSyntaxHeadings">Code39concatenation (META Tag) Syntax
</th>
</tr>
<tr>
...
<tr>
<td valign="top" class="clsSyntaxCells"><b>Code39concatenation:[Value]
							</b></td>
<td valign="top" class="clsSyntaxCells">true/false</td>
<td valign="top" class="clsSyntaxCells">Enables/Disables Code39 bar code concatenation.</td>
...
&lt;!-- &lt;META HTTP-Equiv="Scanner" Content="Code39concatenation:[Value]"&gt; --&gt;      &lt;!-- Enables/Disables Code39 bar code concatenation. --&gt;</textarea></div>
<div style="display:none"><textarea id="txtJavascriptTemplateW">&lt;script&gt;
/*
The Code39concatenation META Tag is an action tag used to set the Code39concatenation property.
*/

function doCode39concatenationInit()
{
var objGeneric = new ActiveXObject("PocketBrowser.Generic");

//objGeneric.InvokeMETAFunction('Scanner', 'Code39concatenation:[Value]');      /* Enables/Disables Code39 bar code concatenation. */
...
<blockquote>
<p>The following example enables the scanner to read only Code39 labels with the concatenation property set to true:</p>
<table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
<tr>
<td>
