---
title: Code11ReportCheckDigit Meta Tag
productversion: '1.5'
...
The Code11ReportCheckDigit Meta Tag is an action tag used to set the Code11 ReportCheckDigit property, which enables reporting of the bar code check digit(s).

<div id="SyntaxSpan" style="display:block">
<blockquote>
<table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
<tr>
<th class="clsSyntaxHeadings">Code11ReportCheckDigit (META Tag) Syntax
</th>
</tr>
<tr>
...
<tr>
<td valign="top" class="clsSyntaxCells"><b>Code11-ReportCheckDigit:[Value]
							</b></td>
<td valign="top" class="clsSyntaxCells">true/false</td>
<td valign="top" class="clsSyntaxCells">Enables reporting of the check digit.</td>
...
&lt;!-- &lt;META HTTP-Equiv="Scanner" Content="Code11-ReportCheckDigit:[Value]"&gt; --&gt;      &lt;!-- Enables reporting of the check digit. --&gt;</textarea></div>
<div style="display:none"><textarea id="txtJavascriptTemplateW">&lt;script&gt;
/*
The Code11ReportCheckDigit META Tag is an action tag used to set the Code11 ReportCheckDigit property which enables reporting of the bar code check digit(s).
*/

function doCode11ReportCheckDigitInit()
{
var objGeneric = new ActiveXObject("PocketBrowser.Generic");

//objGeneric.InvokeMETAFunction('Scanner', 'Code11-ReportCheckDigit:[Value]');      /* Enables reporting of the check digit. */
...
<blockquote>
<p>The following example enables the scanner to read only Code11 labels with the ReportCheckDigit property set:</p>
<table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
<tr>
<td>
