---
title: CodabarCLSiEditing Meta Tag
productversion: '1.5'
...
<tr>
<th class="clsSyntaxHeadings">CodabarCLSiEditing (META Tag) Syntax
</th>
</tr>
<tr>
<td class="clsSyntaxCells">
<pre class="clsSyntaxCells">&lt;META HTTP-Equiv="scanner" content="CodabarCLSiEditing:[parameter&gt;</pre>
</td>
</tr>
</table>
</blockquote><br></div>
...
<tr>
<td valign="top" class="clsSyntaxCells"><b>CodabarCLSiEditing:[Value]
							</b></td>
<td valign="top" class="clsSyntaxCells">true/false</td>
<td valign="top" class="clsSyntaxCells">Enables/Disables CLSi formatting.</td>
...
The CodabarCLSiEditing META Tag is an action tag used to enable Codabar CLSi formatting.
--&gt;

&lt;!-- &lt;META HTTP-Equiv="Scanner" Content="CodabarCLSiEditing:[Value]"&gt; --&gt;      &lt;!-- Enables/Disables CLSi formatting. --&gt;</textarea></div>
<div style="display:none"><textarea id="txtJavascriptTemplateW">&lt;script&gt;
/*
The CodabarCLSiEditing META Tag is an action tag used to enable Codabar CLSi formatting.
*/

function doCodabarCLSiEditingInit()
{
var objGeneric = new ActiveXObject("PocketBrowser.Generic");

//objGeneric.InvokeMETAFunction('Scanner', 'CodabarCLSiEditing:[Value]');      /* Enables/Disables CLSi formatting. */
...
<blockquote>
<p>The following example enables the scanner to read only Codabar labels with the CLSi formatting property set to true:</p>
<table class="clsSyntax" cellspacing="1" cellpadding="3" width="95%">
<tr>
<td>
