...
## Setting Up
Before we begin, make sure you have [downloaded and installed RhoMobile Suite](/rhoelements/rhoelements-tutorial.md/rhomobile-install). Recall that RhoStudio is an Eclipse based IDE that allows you to write a mobile application using HTML, JavaScript and Ruby that will run on multiple mobile platforms. Each mobile platform’s development environment is used in the build process to compile a final executable for that platform. It is imperative that you have this complete development environment setup for each platform you will be building on. The prerequisites and setup for building on each mobile platform (for example, setting up an Android SDK) can be found [here](/rhoelements/rhoelements-tutorial.md/rhodes/build). In this tutorial we will begin by developing using RhoSimulator, but the final application will be running on a device.
...
<img src="http://rhodocs.s3.amazonaws.com/rhoelements-tutorial/image002.png"/>
 
This will create a blank RhoMobile project with a directory structure similar to the one shown in the following image. 

<img src="http://rhodocs.s3.amazonaws.com/rhoelements-tutorial/image003.png"/>
...
<img src="http://rhodocs.s3.amazonaws.com/rhoelements-tutorial/image004.png"/>
...
Towards the bottom of the ‘layout.erb’ file you will see
	<% content %>
...
<img src="http://rhodocs.s3.amazonaws.com/rhoelements-tutorial/image005.png"/>
...
<img src="http://rhodocs.s3.amazonaws.com/rhoelements-tutorial/image006.png"/>
...
<img src="http://rhodocs.s3.amazonaws.com/rhoelements-tutorial/image007.png"/>
...
<img src="http://rhodocs.s3.amazonaws.com/rhoelements-tutorial/image008.png"/>
...
<img src="http://rhodocs.s3.amazonaws.com/rhoelements-tutorial/image009.png"/>
...
## Adding The Product Catalog Data Model
...
<img src="http://rhodocs.s3.amazonaws.com/rhoelements-tutorial/image010.png" />

<img src="http://rhodocs.s3.amazonaws.com/rhoelements-tutorial/image011.png"/>
 
 
NOTE: Pay attention to the case you are using for model attributes. Ruby is case sensitive, so it is recommended that you follow the same case sensitive approach through your code.

Creating a model will add a new folder to the ‘app’ directory with the name of that model along with a set of prebuilt files for different views as well as the model controller to handle the logic for each of these views:
	index.erb: lists all ProductCatalog items
	new.erb: form for creating a new ProductCatalog item
	edit.erb: form for updating an existing ProductCatalog item
	show.erb: page that shows an existing ProductCatalog item
...
<img src="http://rhodocs.s3.amazonaws.com/rhoelements-tutorial/image012.png"/>
...
Now let’s add this model to our ‘app/index.erb’ so that we can see how these methods are already plugged into the application. We will use these CRUD methods for our real application in the upcoming steps, but in a different manor. Open up the ‘/app/index.erb’ file and replace the line:
	<li><a href="#">Add link here...</a></li>
With
	<li><a href="ProductCatalog">Catalog</a></li>
...
<img src="http://rhodocs.s3.amazonaws.com/rhoelements-tutorial/image013.png"/>
...
<img src="http://rhodocs.s3.amazonaws.com/rhoelements-tutorial/image014.png"/>
...
<img src="http://rhodocs.s3.amazonaws.com/rhoelements-tutorial/image015.png"/>
...
<img src="http://rhodocs.s3.amazonaws.com/rhoelements-tutorial/image016.png"/>
...
And the corresponding ‘create’ method in the controller file looks like:
	  def create
...
This creates the new record in the ProductCatalog model and redirects the page back to the index.erb.

<img src="http://rhodocs.s3.amazonaws.com/rhoelements-tutorial/image017.png"/>
...
##Preloading The Product Catalog
To seed our initial database of products under the ProductCatalog, we will have a JSON file with sample data. In a real world scenario, you may choose to use AJAX and Web Services to retrieve your product catalog or you may also use RhoConnect to keep your product catalog synchronized (we will show you how to do this later on). To create the file, right-click on the ‘public’ folder under the application folder and click on New -> File to bring up the new file dialog. Name the file Products.txt and click Finish. This will create an empty text file which we will populate with sample data. Copy and paste the text below.
	...
	[
	{"SKU": "12345", "Name": "Converse Hi-Top", "Image" : "data:image/jpeg;base64,%3D%3D"},
	{"SKU": "67890", "Name": "Skechers Womens", "Image" : "data:image/jpeg;base64,"},
	{"SKU": "12121", "Name": "Pointer Lace-up", "Image" : "data:image/jpeg;base64,%3D"},
	{"SKU": "22222", "Name": "Asics Pacewalker", "Image" : "data:image/jpeg;base64,%3D%3D"},
	]

<img src="http://rhodocs.s3.amazonaws.com/rhoelements-tutorial/image018.png"/>
 

‘SKU’ is the barcode for an item, ‘Name’ is the name of the item and ‘Image’ contains the base64 string representation of the image related to that product. There are tools available online to convert an image to its base64 representation which you can use. This is also referred to as ‘DataURI’ and can be a nice way to handle images without having to have a whole bunch of physical files, you can keep it all in the data scheme. As you may recall, all of the UI is rendered though a browser and the `<IMG>` tag displays base64 strings very nicely.
...
<img src="http://rhodocs.s3.amazonaws.com/rhoelements-tutorial/image019.png"/>
...
<img src="http://rhodocs.s3.amazonaws.com/rhoelements-tutorial/image020.png"/>
...
Notice that the Image field in the detail view will show the raw base64 representation of the image instead of the actual image. To fix this, open up ‘show.erb’ under the ProductCatalog model and change the line 
	<div class="itemValue"><%= @productcatalog.Image %></div>
to 	
	<div class="itemValue"><img src="<%= @productcatalog.Image %>" /></div>

This change prompts the browser to recreate the image from its base64 representation returned by the Ruby code. This sets up our ProductCatalog model with sample products fed into it. 

<img src="http://rhodocs.s3.amazonaws.com/rhoelements-tutorial/image021.png"/>
 
##Adding The Inventory Data Model
...
<img src="http://rhodocs.s3.amazonaws.com/rhoelements-tutorial/image022.png"/>
...
<img src="http://rhodocs.s3.amazonaws.com/rhoelements-tutorial/image023.png"/>
...
<img src="http://rhodocs.s3.amazonaws.com/rhoelements-tutorial/image024.png"/>
...
<img src="http://rhodocs.s3.amazonaws.com/rhoelements-tutorial/image025.png"/>

 
##Changing The Inventory List View
...
<img src="http://rhodocs.s3.amazonaws.com/rhoelements-tutorial/image026.png"/>
...
Add a new file to the Inventory model and call it ‘scanPage.erb’. Open the file and add to it the following code:
	...
	<div data-role="page">
	  ...
	  <div data-role="header" data-position="inline">
		...
		<div data-role="content">
		  <div id="divCountTotal">
		   <a href="/app/Inventory/index" data-role="button" id="numberScanned">0 Items Scanned</a></li>
				  
		  </div>
		  <div id="divImageInventory" style="text-align:center" margin-top="10px">
				<img id="iImage" src="/public/images/barcode.jpg" style="max-width:320px"/>
		  </div>
		  <div id="barcode" style="font-size:1.2em">
		  </div>
		  <div id="productName" style="font-size:1.7em;">
				READY TO SCAN
		  </div>
		  <div id="count" style="text-align:center;font-size:4em">
		  </div>
	  </div>
	</div>
...
<img src="http://rhodocs.s3.amazonaws.com/rhoelements-tutorial/image027.png"/>
...
Let’s look at this function line by line. When the decode event returns after a successful decode, it contains a few parameters (a full list is provided in the [RhoElements API for Scanner](scanner)) out of which we extract the ‘data’ element which contains the barcode that was just scanned. With that barcode, we find the ProductCatalog entry we may have for that product by matching the ‘barcode’ variable to each product’s ‘SKU’.  If we do not have an entry for that barcode, we create a new one with a default ‘Name’ and ‘Image’.

<img src="http://rhodocs.s3.amazonaws.com/rhoelements-tutorial/image028.png"/>
...
Now we have added all of the code to the controller, let’s go back to the scanPage.erb and add the JavaScript functions we are calling.
	...
	$('[data-role=page]').live('pageshow', function (event) {
		  $.get('/app/Inventory/getInventoryCount', { });
		});

	function setProductData(name, SKU, count) {
	  ...
	  function setProductCount(scanCount) {
					  var itemtext = scanCount + " Items Scanned";     
						$('#numberScanned .ui-btn-text').text(itemtext)    
						   
				  }
	
	function setImgSrc(data) {
		document.getElementById("iImage").src = data;          
	}
...
<img src="http://rhodocs.s3.amazonaws.com/rhoelements-tutorial/image029.png" width="500px"/>

<img src="http://rhodocs.s3.amazonaws.com/rhoelements-tutorial/image030.png" width="200px"/>&nbsp; <img src="http://rhodocs.s3.amazonaws.com/rhoelements-tutorial/image031.png" width="200px"/> &nbsp;<img src="http://rhodocs.s3.amazonaws.com/rhoelements-tutorial/image032.png" width="200px"/>
