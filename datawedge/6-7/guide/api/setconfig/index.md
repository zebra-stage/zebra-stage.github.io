...
<p>Used to create, update or replace a DataWedge Profile and its settings. In DataWedge 6.6 and higher, this API also can be used to configure multiple Plug-ins with a single intent action. Beginning with DataWedge 6.7, the behavior of inter-character delay is enhanced. See the <a href="../../output/keystroke">Keystroke Output guide</a> for more information.  </p>
...
<br></p>
<p>To create a Profile without configuring its settings parameters, see <a href="../createprofile">CREATE_PROFILE</a>.</p>
