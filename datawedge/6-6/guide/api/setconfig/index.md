...
<p>Used to create, update or replace a DataWedge Profile and its settings. Beginning with DataWedge 6.6, this API can configure multiple Plug-ins with a single intent action. </p>
<p>This API contains <a href="../overview/#nestedbundles">nested bundles</a>. </p>
...
<ul>
<li><p><strong>BARCODE –</strong> takes a value from the <a href="#scannerinputparameters">Scanner Input Parameters</a> table below; specify decoder and other input settings as <code>EXTRA_DATA</code> in the <code>PARAM_LIST</code> nested bundle</p>
<p><code>scanner_selection_by_identifier</code> [string]- takes a value from the list of <a href="#scanneridentifiers">Scanner Identifiers</a> below</p></li>
...
<ul>
<li><strong>KEYSTROKE -</strong> takes a value from the <a href="#keystrokeoutputparameters">Keystroke Output Parameters</a> table below; specify output settings as <code>EXTRA_DATA</code> in the <code>PARAM_LIST</code> nested bundle</li>
</ul>
