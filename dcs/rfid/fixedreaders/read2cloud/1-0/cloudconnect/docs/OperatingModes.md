...
Note about custom modes ... and link to schema

The following modes are supported in Cloud Connect for RFID:
...
- The radio reports tags every minute. This can be adjusted using the ***Interval*** object when setting the mode.
...
By default:
- The radio attempts to read tags on all antennas. This can be adjusted using the Antennas object when setting the mode.
- The radio reports all unique tags once per trigger. This can be adjusted using the Filter object when setting the mode.
...
By default:
- The radio attempts to read tags on all antennas. This can be adjusted using the Antennas object when setting the mode.
- The radio reports each unique tags once per antenna. This can be adjusted using the Filter object when setting the mode.
